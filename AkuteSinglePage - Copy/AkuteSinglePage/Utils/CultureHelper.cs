...
namespace AkuteSinglePage.Utils
{
    public static class CultureHelper
    {
        ...
        private static readonly List<string> _validCultures = new List<string> { "ru", "ru-RU", "be", "be-BE", "en-EN", "en-US", "en" };
        // Include ONLY cultures you are implementing
        private static readonly List<string> _cultures = new List<string> {
        "be"//,  // first culture is the DEFAULT
        //"ru", // Spanish NEUTRAL culture
        //"en"  // Arabic NEUTRAL culture
